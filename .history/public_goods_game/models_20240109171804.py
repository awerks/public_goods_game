...
class Subsession(BaseSubsession):
    def creating_session(self):
        ...
        if self.round_number == 1:
            ...
            print("Punishment condition!" if self.session.vars["punishment_condition"] else "No punishment condition!")
...
number_of_players = 5  # This could be n for a dynamic number
