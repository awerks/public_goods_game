...
mgslider.prototype.markup = function () {
    return "\
        <div id='" + this.id("wrapper") + "' class='mgslider-wrapper'>\
            <div class='mgslider-limit'>" + this.f2s(this.min, true) + "</div>\
            <input type='range' id='" + this.id() + "' min='" + this.min + "' max='" + this.max + "' step='" + this.step + "' value='" + this.min + "' class='mgslider form-range' oninput='mgsliders.lookup(\"" + this.field + "\").change()' onchange='mgsliders.lookup(\"" + this.field + "\").change()'>\
            <div class='mgslider-limit'>" + this.f2s(this.max, true) + "</div>\
        </div>\
        <div id='" + this.id("show") + "' class='mgslider-show'>" + this.yourvalue + ": <b><span id='" + this.id("cur") + "' class='mgslider-value'></span></b></div>\
        <input type='hidden' id='" + this.id("input") + "' name='" + this.field + "' value='" + this.min + "'>";
};
